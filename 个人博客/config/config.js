var config = {
    ...
    age: "20",
    phone: "17377637705",
    email: "wxk0246@163.com",
    address: "现居江苏省徐州市",
    qq: "3468215937",
    log: "作者单身",
    excpect_work: "python全栈/爬虫",
    ...
    about: "<p>你好！我叫魏新科，性别男，电子信息学院大三。我期望的工作岗位是“爬虫工程师”。</p>" +
        "<p>我有着较多的python/爬虫 经验，计算机基础知识掌握扎实，能够在工作中很好的完成自己的任务。此外，我有着充满激情的工作态度，团队协同作战能力强，同时我也具备独立开发的能力，擅于发现并解决问题。我的执行力强、责任感高、集体荣誉感强、敢于担当，能够接受加班或出差等安排</p>" +
        "<p>十分期待与您的联系!</p>",
    ...
    */  
     ...
     */
    portfolio: [
        ["./images/pro-1.png", "", "爱心", "啊涩同款爱心<br>持续更新"],
        ["./images/pro-2.png", "www.wanke.love", "3D爱心", "电视剧热播爱心<br>2021/7/23"],
        ["./images/1.png", "www.liujuinnan.xyz", "表白", "向女朋友表白"]
    ],
    ...
    icon: [
       // ["./svg/LeetCode.svg", "https://leetcode-cn.com/u/happysnaker/", "我的力扣主页"],
        ["./svg/github.svg", "https://github.com/1-wei-2", "我的GitHub主页"],
        ["./svg/博客.svg", "http://1.15.234.109:8000", "我的个人博客"],
        ["./svg/掘金.svg", "https://juejin.cn/user/427085605122296", "我的掘金主页"],
        ["./svg/知乎.svg", "https://www.zhihu.com/people/wei-peng-66-76", "我的知乎主页"]
    ],
